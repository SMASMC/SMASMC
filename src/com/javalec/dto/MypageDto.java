...
public class MypageDto {
	...
	public MypageDto(String custid, String custname, String custphone, String custaddress,String custemail, int custpoint) 
	{
		super();
		this.custid = custid;
		this.custname = custname;
	...
	public MypageDto(String custpassword, String custname) {
		super();
		this.custpassword = custpassword;
		this.custname = custname;
